#-------------------------------------------------
#
# Project created by QtCreator 2018-02-28T14:19:29
#
#-------------------------------------------------

QT       -= core gui

win32:TARGET = ../../../dist/bin/glazingsolarfactorventilation
TEMPLATE = lib

DEFINES += GLAZINGSOLARFACTORVENTILATION_LIBRARY

SOURCES += glazingsolarfactorventilation.cpp

HEADERS += glazingsolarfactorventilation.h\
        glazingsolarfactorventilation_global.h
